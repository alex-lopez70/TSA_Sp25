...
#p-value < 0.05 so we can conclude a positive trend
#this confirms the results from the Mann Kendall and Seasonal Mann Kendall tests
...
#p-value < 0.05 so we reject the null hypothesis in favor of the alternative
#good example of this being 'stationary' over a unit root
