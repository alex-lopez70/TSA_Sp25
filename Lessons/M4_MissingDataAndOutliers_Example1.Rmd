...
#there are NAs bc of NAs in the trend component due to the moving average -
#moving average method makes us lose first 6 and last 6 monthly values
...
head(df_inflow_random,10)
tail(df_inflow_random,10)
#now begins in july and ends in february
